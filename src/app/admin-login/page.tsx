  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-cyber-navy-dark relative overflow-hidden min-h-screen py-12 px-4">
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center gap-6">
        ...
        <div className="w-full bg-slate-900/40 backdrop-blur-xl border border-slate-900 rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-850 focus:border-indigo-500 rounded-xl px-4 py-3 text-slate-100 placeholder-slate-700 transition-all text-xs outline-none"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-500 disabled:from-indigo-800 text-white font-bold text-xs rounded-xl shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/30 transition-all flex items-center justify-center gap-1.5 cursor-pointer mt-6"
            >
              {loading ? (
                <>
        ...
        <Link
          href="/"
          className="flex items-center gap-1.5 text-xs text-slate-650 hover:text-slate-400 transition-colors"
        >

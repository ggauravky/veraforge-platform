  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      <svg className="absolute w-full h-full opacity-[0.08] animate-pulse-slow" xmlns="http://www.w3.org/2000/svg">
        ...
        <line x1="120" y1="180" x2="340" y2="310" stroke="#00ffff" strokeWidth="1" className="animate-dash" />
        <line x1="340" y1="310" x2="560" y2="180" stroke="#00ffff" strokeWidth="1.5" className="animate-dash" />
        <line x1="560" y1="180" x2="780" y2="440" stroke="#0ea5e9" strokeWidth="1" className="animate-dash" />
        <line x1="340" y1="310" x2="340" y2="570" stroke="#00ffff" strokeWidth="0.75" />
        <line x1="780" y1="440" x2="1000" y2="310" stroke="#00ffff" strokeWidth="1.5" className="animate-dash" />
        <line x1="1000" y1="310" x2="1220" y2="440" stroke="#0ea5e9" strokeWidth="1" className="animate-dash" />
...
function ConvergingHeroGraphic() {
  return (
    <div className="relative w-full max-w-[480px] h-[340px] mx-auto flex items-center justify-center mt-12 lg:mt-0">
      <div className="absolute w-64 h-64 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none animate-pulse-slow" />
      <div className="absolute w-48 h-48 bg-blue-500/5 rounded-full blur-3xl pointer-events-none animate-pulse-slow" />
      ...
      <svg className="w-full h-full relative z-10" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="200" cy="150" r="32" stroke="#0ea5e9" strokeWidth="1" strokeOpacity="0.4" strokeDasharray="5 3" className="animate-spin-slow" style={{ transformOrigin: '200px 150px' }} />
        <circle cx="200" cy="150" r="52" stroke="#00ffff" strokeWidth="1" strokeOpacity="0.15" />
        <circle cx="200" cy="150" r="75" stroke="#0ea5e9" strokeWidth="0.5" strokeOpacity="0.08" />
      </svg>
      
      {/* Floating Glass Console Preview Overlay */}
      <div className="absolute bottom-[-16px] right-[-10px] w-64 bg-slate-950/80 border border-cyan-500/25 rounded-2xl p-4 backdrop-blur-md shadow-[0_0_35px_rgba(0,255,255,0.12)] z-20 font-mono text-[9px] text-slate-350 select-none hidden sm:block animate-pulse-slow">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 md:gap-8">
            ...
            {isUserSignedIn ? (
              <Link 
                href="/dashboard"
                className="px-5 py-2.5 bg-gradient-to-r from-cyan-500 to-sky-600 hover:from-sky-600 hover:to-cyan-500 text-slate-950 font-extrabold text-xs rounded-xl shadow-lg shadow-cyan-500/10 hover:shadow-cyan-500/30 transition-all duration-300 hover:scale-[1.02]"
              >
                Go to Dashboard
              </Link>
            ) : (
              <>
                ...
                <Link 
                  href="/sign-up"
                  className="px-5 py-2.5 bg-cyber-navy-light/60 hover:bg-cyber-navy-light text-electric-cyan border border-electric-cyan/20 hover:border-electric-cyan/50 font-bold text-xs rounded-xl transition-all flex items-center gap-1.5 shadow-[0_0_15px_rgba(0,255,255,0.02)] hover:shadow-[0_0_20px_rgba(0,255,255,0.15)]"
                >
                  Apply as Student
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center w-full sm:w-auto">
            {isUserSignedIn ? (
              <Link 
                href="/dashboard"
                className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-electric-cyan to-sky-500 hover:from-sky-550 hover:to-electric-cyan text-slate-950 font-extrabold rounded-xl shadow-xl shadow-cyan-500/10 hover:shadow-cyan-500/35 hover:scale-[1.03] transition-all duration-300 flex items-center justify-center gap-2 text-xs uppercase tracking-wider cursor-pointer"
              >
              ...
              <>
                ...
                <Link 
                  href="/sign-in"
                  className="w-full sm:w-auto px-8 py-4 bg-cyber-navy-light/30 hover:bg-cyber-navy-light/60 text-slate-355 hover:text-white font-bold rounded-xl border border-slate-800 hover:border-slate-700 transition-all hover:scale-[1.01] text-xs uppercase tracking-wider"
                >
                  Sign In
                </Link>
              </>
      ...
      <section className="relative z-10 border-y border-slate-900/60 bg-cyber-navy-light/10 backdrop-blur-sm py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-50">
            {/* Logo 1 */}
            <svg className="h-6 w-20 text-sky-400 hover:text-electric-cyan transition-colors" viewBox="0 0 100 30" fill="currentColor">
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {[
              ...
              >
                {/* Timeline node icon */}
                <div className="absolute left-6 md:left-1/2 -translate-x-[11px] w-6 h-6 rounded-full bg-cyber-navy-dark border-[3px] border-electric-cyan shadow-[0_0_12px_#00ffff] flex items-center justify-center z-10" />

                {/* Card Container */}
                <div className="w-full md:w-1/2 pl-12 md:pl-0 md:px-8">
                  <div className="glass-panel rounded-3xl p-8 hover:border-electric-cyan/35 hover:shadow-[0_0_30px_rgba(0,255,255,0.12)] hover:-translate-y-1 transition-all duration-300 bg-cyber-navy-light/15">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pb-24 w-full">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div 
              key={idx}
              className="glass-panel rounded-3xl p-8 flex flex-col justify-between hover:border-electric-cyan/35 hover:shadow-[0_0_35px_rgba(0,255,255,0.1)] hover:-translate-y-1.5 transition-all duration-350 relative group bg-cyber-navy-light/10 overflow-hidden"
            >
              ...
              <div className="mt-8 text-[9px] text-slate-500 font-bold uppercase tracking-wider flex justify-between items-center">
                ...
                <span className="w-1.5 h-1.5 bg-electric-cyan rounded-full shadow-[0_0_6px_#00ffff]" />
              </div>
            </div>
          ))}
        </div>

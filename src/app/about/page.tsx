...
import { Shield, ArrowLeft, Cpu, Compass, Layers, CheckSquare, GraduationCap } from 'lucide-react';

export const dynamic = 'force-dynamic';

export default function AboutPage() {
  return (
    <div className="flex-1 flex flex-col bg-slate-950 relative overflow-hidden min-h-screen text-slate-300">

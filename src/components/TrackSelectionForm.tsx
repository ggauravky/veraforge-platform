...
import { 
  Shield, Globe, Server, Database, Cpu, ArrowRight, Loader2, Sparkles 
} from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="block text-[10px] text-indigo-400 font-bold tracking-[0.2em] uppercase">Workspace Setup</span>
            </div>
          </div>
